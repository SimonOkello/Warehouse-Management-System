<div class="span3" id="sidebar">
	<?php $query= mysql_query("select * from customers where user_id = '$session_id'")or die(mysql_error());
	...
	<img id="avatar" src="admin/uploads/<?php $image=$row['image']; echo $image; ?>" class="img-polaroid">
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class=""><a href="cust_Order.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;ORDERS</a></li>
