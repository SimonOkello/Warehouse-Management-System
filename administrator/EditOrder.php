    ...
    $row = mysql_fetch_array(mysql_query("SELECT status FROM `orders` WHERE `order_id` = '$order_id' "));
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								...
  								<a href='orders.php' class='btn btn-primary'><i class="icon-arrow-left icon-white"></i> Back To Orders</a>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		<script src="../norwille/administrator/bootstrap/js/jquery-ui.js"></script>
    </body>
</html>
