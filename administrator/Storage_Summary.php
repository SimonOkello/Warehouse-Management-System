<?php
 ...
 include('admin/dbcon.php'); ?>
                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								<li><a href="#">Storage Occupied: </a></li>
						</ul>
						 <!-- end breadcrumb -->
   ...
   <script>
      ...
      <?php 
            $query = "SELECT SUM(qty) as result FROM products GROUP BY company_name ORDER BY company_name ASC";
            $response = @mysql_query($query);
      ?>
      var labels = ["Lenovo","Safaricom"];
      var data = [
            <?php 
